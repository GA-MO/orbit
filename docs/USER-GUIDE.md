...
อยากทำงานต่อ กดปุ่ม **New** ที่มุมขวาบนของ terminal ได้เลย — เปิด session ใหม่
ด้วย agent + โฟลเดอร์ + ชื่อเดิม (เป็นการเริ่มใหม่ ไม่ใช่การต่อบทสนทนาเดิมของ
agent) หรือกด ＋ ในแท็บ Sessions ก็ได้เหมือนกัน
